...
class CuteInterpreter(object):
    ...
    def run_arith(self, arith_node):
        ...
        if arith_node.type is TokenType.PLUS:
            ...
            elif int(rhs1.value) < int(rhs2.value):
    ...
    def run_func(self, func_node):
        ...
        if func_node.type is TokenType.CAR:
            ...
            if result1.type is not TokenType.LIST:
                print "is not list ERROR"
                return result
            return result1
            ...
            if list_is_null(rhs1): return self.TRUE_NODE
            result = pop_node_from_quote_list(rhs1)
            if result.type is not TokenType.INT: return self.FALSE_NODE
            if result.type is TokenType.INT:
